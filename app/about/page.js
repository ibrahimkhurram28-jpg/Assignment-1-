  ...
  return (
    <div className="mx-auto max-w-3xl px-4 sm:px-6 py-14">
      ...
      <section className="mb-8">
        ...
        <p style={{ color: "var(--color-ink-soft)" }}>
          This build is Assessment 1 and is frontend only. There is no database or backend. The
          Wordle activity is built around a single fixed phoneme word, and the Word Search activity
          uses a small fixed list of five phoneme-based words. Dynamic word lists and database-driven
          generation are planned for a later assessment.
        </p>
      </section>
      ...
      <section className="mb-8">
        ...
        <ul className="space-y-2" style={{ color: "var(--color-ink-soft)" }}>
          <li>
            <strong style={{ color: "var(--color-ink)" }}>Wordle</strong>: a teacher enters a
            phoneme word and its English match, then students guess it phoneme by phoneme with
            Wordle-style colour feedback.
          </li>
          <li>
            <strong style={{ color: "var(--color-ink)" }}>Word Search</strong>: a fixed set of
            phoneme-based words is hidden in a letter grid, with phonetic clues that reveal their
